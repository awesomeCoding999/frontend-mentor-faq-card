...
function App() {
  return (
    <div>
      ...
      my subscription? Yes! Send us a message and we&apos;ll process your
      request no questions asked. Do you provide additional support? Chat and
      email support is available 24/7. Phone lines are open during normal
      business hours.
      <footer className="attribution">
        ...
        . Coded by{" "}
        <a href="https://www.frontendmentor.io/profile/awesomeCoding999">
          @awesomeCoding999
        </a>
        .
      </footer>
